 ...
 *      mode (ViewerMode='none'), on `noscale`, on narrow viewports
     *      (≤640px), and via the `no-rail` / `norail` attribute. Rail mutations dispatch
...
(() => {
  ...
  class DeckStage extends HTMLElement {
    static get observedAttributes() { return ['width', 'height', 'noscale', 'no-rail', 'norail']; }
    ...
    _enableRail() {
      ...
      if (this._railEnabled || this.hasAttribute('no-rail') || this.hasAttribute('norail')) return;
    ...
    _railWidth() {
      ...
      // corrects it.
      if (!this._railEnabled || !this._railVisible || this.hasAttribute('no-rail') || this.hasAttribute('norail')
